...
enum Theme {
    ...
    enum Palette {
        ...
        // Online-Modus
        static let coin        = Color(light: 0xB08A3E, dark: 0xD4AF5E) // Münzen
        static let live        = Color(light: 0x4C9A6B, dark: 0x63B584) // Aktiv in Session
        static let success     = Color(light: 0x4C7A5A, dark: 0x77A98A)
    }
