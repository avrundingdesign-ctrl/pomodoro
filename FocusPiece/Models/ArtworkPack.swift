    ...
    static let impressionen = ArtworkPack(
        ...
        works: [
            Artwork(id: "water_lilies",
                    ...
                    packID: "impressionen",
                    requirement: ArtworkRequirement(rounds: 1, minutesPerRound: 15)),
            Artwork(id: "moulin_galette",
                    ...
                    packID: "impressionen",
                    requirement: ArtworkRequirement(rounds: 2, minutesPerRound: 25)),
            Artwork(id: "paris_rainy_day",
                    ...
                    packID: "impressionen",
                    requirement: ArtworkRequirement(rounds: 3, minutesPerRound: 25)),
            Artwork(id: "woman_parasol",
                    ...
                    packID: "impressionen",
                    requirement: ArtworkRequirement(rounds: 2, minutesPerRound: 45)),
        ])
    ...
    static let goldenesZeitalter = ArtworkPack(
        ...
        works: [
            Artwork(id: "pearl_earring",
                    ...
                    requirement: ArtworkRequirement(rounds: 1, minutesPerRound: 25)),
            Artwork(id: "milkmaid",
    ...
    static let nachtstuecke = ArtworkPack(
        ...
        works: [
            ...
            Artwork(id: "starry_rhone",
                    ...
                    packID: "nachtstuecke",
                    requirement: ArtworkRequirement(rounds: 3, minutesPerRound: 45)),
        ])
...
extension Artwork {
    ...
    static let seedCollection: [Artwork] = [
        ...
        Artwork(id: "red_fuji",
                ...
                requirement: ArtworkRequirement(rounds: 4, minutesPerRound: 25)),
        ...
        Artwork(id: "harvesters",
                ...
                requirement: ArtworkRequirement(rounds: 4, minutesPerRound: 45)),
    ]
}
